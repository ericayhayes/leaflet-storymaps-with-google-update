(function (root, factory) {
	...
	L.TileLayer.Provider.providers = {
		...
		MapBox: {
			url: 'https://api.mapbox.com/styles/v1/dr-c/ckc6hgwxx111z1intlp2qo7ww/tiles/256/{z}/{x}/{y}@2x?access_token=pk.eyJ1IjoiZHItYyIsImEiOiJja2MyMnF2bzYwMDg5MnFwN2o5bTFicTQ0In0.6BoyTjfVF6UN6w2gbRMi_h',
			options: {
				attribution:
